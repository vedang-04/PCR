...
def augment(img, split, _data_rng, _eig_val, _eig_vec, mean, std, polys=None):
    ...
    trans_input = data_utils.get_affine_transform(center, scale, rot_angle, [input_w, input_h])
    ...
    trans_output = data_utils.get_affine_transform(center, scale, rot_angle, [output_w, output_h])

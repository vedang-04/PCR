...
class NetworkWrapper(nn.Module):
    ...
    def forward(self, batch):
        ...
        # if cfg.dist_constraint: dist_constraint_loss = self.dist_constraint_crit(output['wh'], batch['wh'],
        # batch['ct_ind'], batch['ct_01']) scalar_stats.update({'dist_constraint_loss': dist_constraint_loss}) loss
        # += dist_constraint_loss

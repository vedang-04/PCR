...
def resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        model.load_pretrained_model(data='imagenet', name='resnet50', model_url=model_url)
...
class FeatEnhance(nn.Module):
    def __init__(self, o, channels, up_f, emb_type=None):
        super(FeatEnhance, self).__init__()
...
class DLASeg(nn.Module):
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel,
        ...
        if cfg.backbone_name != 'default':
            base_name = cfg.backbone_name

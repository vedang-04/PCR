...
# cfg.train.num_workers = 5

# use adam as default
cfg.train.optim = 'adam'
cfg.train.lr = 1e-4
# cfg.train.weight_decay = 2.5 * (10 ** (-4))
...
cfg.use_otpg_flag = True  # whether using the oriented text proposal generation module to initialize the contour.
# default is true
...
# cfg.ex_type = 'center'  # corner, extreme
cfg.evolve_init = 'ex'  # 'poly' or 'ex'
cfg.hbb_enclose_type = 'poly'  # 'obb' means enclose the oriented box, otherwise enclose the poly
